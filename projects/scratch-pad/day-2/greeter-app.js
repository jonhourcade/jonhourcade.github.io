...
function greeter(hour) {
    ...
    // test if hour is less than twelve
    if (hour < 12) {
        console.log("Good Morning!");
       
    // we only reach this code if hour is less than twelve
    // don't need to test if its greater than eleven and less than seventeen
    } else if (hour < 17) {
    ...
    // don't use else
    // if you do, someone could pass in a number greater than 24 and the following block would execute
    } else if (hour < 25) {
