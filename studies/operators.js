...
/**
 * The ternary operator requires three operands. The first operand must 
 * evalute to true or false. The second operand is returned if the first 
 * operand tests true. The third operand is returned if the first operand tests 
 * false. This is especially useful when an the code block following the if
 * and else keywords contain one line of code. For example:
 */
 ...
 // can be rewritten using the ternary operator
 let averageWeight = (gender === "male") ? 180 : 130;
 
/**
 * Ternary operators can be nested if more than two possibilities exist
 */
 
let os1 = "apple";
let os2 = "windows";

let sortInt = (os1 < os2) ? -1 : 
 (os1 === os2) ? 0 : 1;